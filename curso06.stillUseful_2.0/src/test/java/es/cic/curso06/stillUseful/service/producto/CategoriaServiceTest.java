...
public class CategoriaServiceTest {
	...
	public void testCrearCategoria() {
		...
		Categoria nuevoCategoria = categoriaService.crearCategoria("Pantalones - Jeans", 
				"Vaqueros.");
	...
	public void testEditarCategoria() {
		...
		boolean editado = categoriaService.editarCategoria(categoria.getId(),
	...
	public void testListarCategoria() {
		...
		setNuevoCategoria(categoriaService.crearCategoria("shooter", "fdasfdadf15646afd456as"));
