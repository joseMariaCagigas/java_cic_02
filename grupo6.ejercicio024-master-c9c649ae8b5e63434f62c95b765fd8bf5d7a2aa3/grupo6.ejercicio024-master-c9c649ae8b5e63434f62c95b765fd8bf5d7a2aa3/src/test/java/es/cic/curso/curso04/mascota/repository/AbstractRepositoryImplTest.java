...
import es.cic.curso.grupo6.ejercicio024.repositorio.Identificable;
...
public abstract class AbstractRepositoryImplTest<K extends Number, T extends Identificable<K>> {
	...
	public abstract Repositorio<K, T> getRepository();
	...
	public void testAdd() {
		...
		instancia = getRepository().create(instancia);
