...
public class ServicioGestorCineTest {
	...
	private Sala generaSalaPrueba(int capacidad) {
		Sala sala = new Sala();
	...
	private Sesion generaSesionPrueba(Sala sala) {
	...
	public void testAgregaSesion() {
		...
		Sala sala = generaSalaPrueba(CAPACIDAD_SALA1);
		sesion = new Sesion();
		assertNull(sesion.getId());
	...
	public void testObtenSala() {
		Sala elemento1 = generaSalaPrueba(CAPACIDAD_SALA1);
	...
	public void testObtenSesion() {
		...
		Sesion elemento1 = generaSesionPrueba(sala);
	...
	public void testModificaSala() {
		...
		original = generaSalaPrueba(CAPACIDAD_SALA1);
		clon = new Sala();
	...
	public void testModificarSesion() {
		...
		Sesion original = generaSesionPrueba(sala);
	...
	public void testEliminaSala() {
		...
		// 1) Sala sin sesiones programadas
		sala = generaSalaPrueba(CAPACIDAD_SALA1);
	...
	public void testEliminaSesion() {
		Sala sala = generaSalaPrueba(CAPACIDAD_SALA1);
		Sesion elemento = generaSesionPrueba(sala);
	...
	public void testListaSalas() {
		...
		for (int i = 0; i < numero; i++) {
			generaSalaPrueba(CAPACIDAD_SALA1);
		}
